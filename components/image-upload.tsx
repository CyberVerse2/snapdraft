...
export function ImageUpload({ onImageUpload }: ImageUploadProps) {
  ...
  return (
    <div className="space-y-8">
      <div
        {...getRootProps()}
        className={`border-8 border-black cursor-pointer transition-all ${
          isDragActive
            ? "bg-yellow-400 shadow-[8px_8px_0px_0px_#000000]"
            : "bg-gray-100 hover:bg-yellow-200 hover:shadow-[8px_8px_0px_0px_#000000]"
        }`}
      >
          ...
          {preview ? (
            ...
            <div className="text-center space-y-6">
              ...
              <div>
                ...
                <p className="text-lg font-bold uppercase tracking-wide">PNG, JPG, WEBP • MAX 10MB</p>
              </div>
